...
sendText(addEmployee.firstNameField,"JoshSholpan");
       // WebElement lastName = driver.findElement(By.id("lastName"));
       // lastName.sendKeys("yuria");
        sendText(addEmployee.lastNameField, "veranuallah");
    }
    ...
    @When("user enter {string} and {string} for multiple employees")
    public void user_enter_and_for_multiple_employees(String firstNameValue, String lastNameValue) {
